 ...
 * pre-filled tabs of type text and radio button.
 *
...
eg001EmbeddedSigning.worker = async (args) => {
 ...
 console.log(`Envelope successfully created: EnvelopeId ${envelopeId}`);
...
/**
* Creates envelope with parent and admin signers
* @function
...
function makeEnvelope(docInfo, signerClientId) {
 ...
 doc1.name = docInfo.docName + ": Homeowner"; // can be different from actual file name
 ...
 doc2.name = docInfo.docName + ": Admin"; // can be different from actual file name
